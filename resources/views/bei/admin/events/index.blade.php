    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.bei.events.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                    Reset
                </a>
            </div>
        </form>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form id="delete-form-{{ $event->id }}" action="{{ route('admin.bei.events.destroy', $event) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
